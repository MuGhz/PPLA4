	...
	$.post("{{action('OrderController@getOrder')}}",{_token: "{{csrf_token()}}",orderId:"{{$orderId}}",token:"{{$token}}",id:"{{$id}}"}).done(function(e){
        ...
        @if($claimType == 1)
            ...
            @else
                ...
                temp+= "<p>Status klaim: " +'{{$status}}'+"</p>";
                temp+= "<hr>";
                temp+= "<p>Tipe: "+e.result.order__cart_detail[0].order_type+"</p>";
                temp+= "<p>"+e.result.order__cart_detail[0].order_name+"</p>";
                temp+= "<p>Jenis kamar: "+e.result.order__cart_detail[0].order_name_detail+"</p>";
                temp+= "<div class='form-group col-md-6'>";
                temp+= "<p>Dewasa: "+e.result.order__cart_detail[0].detail.room_adult+"</p>";
                temp+= "</div>";
                temp+= "<div class='form-group col-md-6'>";
                temp+= "<p>Anak-anak: "+e.result.order__cart_detail[0].detail.room_child+"</p>";
                temp+= "</div>";
                temp+= "<div class='form-group col-md-6'>";
                temp+= "<p>Checkin: "+e.result.order__cart_detail[0].detail.checkin+"</p>";
                temp+= "</div>";
                temp+= "<p>Description:</p>";
                temp+= "<p>"+description+"</p>";
                temp+= "<hr>";
                temp+= "<p>Total: Rp. "+e.result.order__cart_detail[0].customer_price+"</p>";
                temp+= "<p>Order Expired: "+e.result.order__cart_detail[0].detail.order_expire_datetime+"</p>";
                temp+= "<br>";
                temp+= "</div>";
                temp+= "</div></center>";
                temp+= "<div class='col-md-3'>";
        ...
        @elseif ($claimType == 2)
            ...
            @else
                ...
                temp+= "<hr>";
                temp+= "<p>Tipe : "+e.result.order__cart_detail[0].order_type+"</p>";
                temp+= "<p>Rute : "+e.result.order__cart_detail[0].order_name+"</p>";
                temp+= "<p>Maskapai : "+e.result.order__cart_detail[0].detail.airlines_name+"</p>";
                temp+= "<p> Nomor penerbangan : "+e.result.order__cart_detail[0].detail.flight_number+"</p>";
                temp+= "<p>Bandara keberangkatan : "+e.result.order__cart_detail[0].detail.depart_airport+"</p>";
                temp+= "<p>waktu keberangkatan : "+e.result.order__cart_detail[0].detail.departure_time+"</p>";
                temp+= "<p>Bandara tujuan : "+e.result.order__cart_detail[0].detail.arrival_airport+"</p>";
                temp+= "<p>waktu tujuan : "+e.result.order__cart_detail[0].detail.arrival_time+"</p>";
                temp+= "<p>Description:</p>";
                temp+= "<p>"+description+"</p>";
                temp+= "<hr>";
                temp+= "<p>Total: Rp. "+e.myorder.data[0].customer_price	+"</p>";
